...
ALL_ROLE_SLUGS="backend-architect code-auditor debugger frontend-engineer pair-programmer perf-engineer refactor-architect startup-mvp"
...
test_update_restores_deleted_role_pack() {
  ...
  for fname in INDEX.md backend-architect.md code-auditor.md debugger.md \
    frontend-engineer.md pair-programmer.md perf-engineer.md \
    refactor-architect.md startup-mvp.md; do
